...
#Maintainer
ro.aos.maintainer=DarkJoker(Nikhil)

export AOS_BUILD_TYPE=PLASMA
export KBUILD_BUILD_NAME=Nikhil
export KBUILD_BUILD_USER=DarkJokeR 
WITH_MUSICFIX :=true
